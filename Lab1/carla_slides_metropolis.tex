...
\medskip
\footnotesize
Note: CARLA can also run with a discrete GPU (not integrated) with at least 4 GB VRAM and sufficient system RAM (16 GB+).
\end{frame}
...
If you want to use your own PC, download CARLA 0.9.15 from the official site:
\begin{itemize}
  \item GitHub releases: \url{https://github.com/carla-simulator/carla/releases}
\end{itemize}

\medskip
If you use the lab PCs, CARLA is already available. Follow these steps:
\begin{itemize}
  \item Open File Explorer
  \item Go to This PC
  \item Open Local Disk (C:)
  \item Enter the \texttt{Carla\_0.9.15} folder
\end{itemize}
\end{frame}
